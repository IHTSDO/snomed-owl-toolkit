...
public class RF2ToOWLServiceTest {
	...
	public void convertRF2ArchiveToOWL() throws Exception {
		...
		rf2ToOWLService.convertRF2ArchiveToOWL(null, "20180731", DescriptionType.FSN, Concepts.US_LANGUAGE_REFERENCE_SET,
				new InputStreamSet(rf2ArchiveStream), new OptionalFileInputStream(null), byteArrayOutputStream);
	...
	public void convertRF2ArchiveToOWLIncludingFictitiousDataAttribute() throws Exception {
		...
		ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
		final FileInputStream rf2ArchiveStream = new FileInputStream(baseRF2SnapshotZip);
		rf2ToOWLService.convertRF2ArchiveToOWL(null, "20180801", DescriptionType.FSN, Concepts.US_LANGUAGE_REFERENCE_SET,
				new InputStreamSet(rf2ArchiveStream), new OptionalFileInputStream(fictitiousDataAttributeDelta), byteArrayOutputStream);
