...
public class RF2Headers {
	...
	public static final String OWL_EXPRESSION_REFERENCE_SET_HEADER = "id\teffectiveTime\tactive\tmoduleId\trefsetId\treferencedComponentId\towlExpression";
